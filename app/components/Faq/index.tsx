...
const faqdata: faqdata[] = [
    {
        ...
        subheading: 'NordicLM is an open-source project designed to help developers build intelligent,modular AI systems.With both short-term and long-term memory,agentic AI concepts and build-in support for ETL and embeddings,NordicLM makes it simple to experiment,extend and scale AI applications.'
    },
    // {
